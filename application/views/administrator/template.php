...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <?php 
            if($this->uri->segment(2)!='home' AND $this->uri->segment(2)!=''){
              ...
              echo "<li class='breadcrumb-item'>Hii, Welcome!</li>";
            }
          ?>
          </ol>
          </div><!-- /.col -->
  ...
  <footer class="main-footer text-sm">
    <strong>Copyright &copy; 2022-<?php echo date('Y'); ?> <a target='_BLANK' href="Mediaverse"><?php echo $iden['nama_website']; ?></a>.</strong>
    All rights reserved.
